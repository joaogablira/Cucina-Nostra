        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form class="d-flex search-container mx-lg-3 my-3 my-lg-0" action="index.php" method="GET" style="flex-grow: 1; max-width: 400px;">
                <div class="input-group shadow-sm" style="border-radius: 50px; overflow: hidden;">
                    <input class="form-control border-0 px-4" type="search" name="busca" placeholder="Buscar prato ou chef..." value="<?php echo isset($_GET['busca']) ? htmlspecialchars($_GET['busca']) : ''; ?>" style="box-shadow: none; background-color: #f8f9fa;">
            ...
            <div class="d-flex align-items-center mt-2 mt-lg-0 gap-3">
                ...
                <button id="themeToggleBtn" class="border-0 bg-transparent" onclick="toggleTheme()" style="padding: 0; cursor: pointer;">
                    <lottie-player
                        id="lottie-theme"
                        src="assets/img/moon-to-sun.lottie"
                ...
                <?php else: ?>
                    <a href="login.php" class="btn btn-light text-success fw-bold rounded-pill px-4 py-2 shadow-sm">Entrar / Cadastrar</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
